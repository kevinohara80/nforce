...
describe('query', function () {
  ...
  describe('#query', function () {
    var expected =
      '/services/data/v27.0/query?q=SELECT%20Id%20FROM%20Account%20LIMIT%201';
  ...
  describe('#queryAll', function () {
    var expected =
      '/services/data/v27.0/queryAll?q=SELECT%20Id%20FROM%20Account%20LIMIT%201';

    it('should work in multi-user mode', function (done) {
      orgMulti.queryAll(
        { query: testQuery, oauth: oauth },
        function (err, res) {
          api.getLastRequest().url.should.equal(expected);
          verifyAccessToken();
          done();
