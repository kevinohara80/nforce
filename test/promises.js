...
describe('promises', function () {
  ...
  describe('#insert', function () {
    it('should not return a promise with a callback', function () {
      var promise = org.insert(
        { sobject: testAccount, oauth: oauth },
        testCallback
      );
      should.not.exist(promise);
    });
    ...
    it('should return a promise with no callback', function () {
      var promise = org
        .insert({ sobject: testAccount, oauth: oauth })
        .catch(function (err) {});
      should.exist(promise);
    });
  });
  ...
  describe('#update', function () {
    ...
    it('should return a promise with no callback', function () {
      var promise = org
        .update({ sobject: testAccount, oauth: oauth })
        .catch(function (err) {});
      should.exist(promise);
    });
  });
  ...
  describe('#upsert', function () {
    ...
    it('should return a promise with no callback', function () {
      var promise = org
        .upsert({ sobject: testAccount, oauth: oauth })
        .catch(function (err) {});
      should.exist(promise);
    });
  });
  ...
  describe('#delete', function () {
    ...
    it('should return a promise with no callback', function () {
      var promise = org
        .delete({ sobject: testAccount, oauth: oauth })
        .catch(function (err) {});
      should.exist(promise);
    });
  });
  ...
  describe('#getRecord', function () {
    it('should not return a promise with a callback', function () {
      var promise = org.getRecord(
        { type: 'Account', id: 'Id', oauth: oauth },
        testCallback
      );
      should.not.exist(promise);
    });
    ...
    it('should return a promise with no callback', function () {
      var promise = org
        .getRecord({ type: 'Account', id: 'Id', oauth: oauth })
        .catch(function (err) {});
      should.exist(promise);
    });
  });
  ...
  describe('#getBody', function () {
    it('should not return a promise with a callback', function () {
      var promise = org.getBody(
        { type: 'Document', id: 'Id', oauth: oauth },
        testCallback
      );
      should.not.exist(promise);
    });
    ...
    it('should return a promise with no callback', function () {
      var promise = org
        .getBody({ type: 'Document', id: 'Id', oauth: oauth })
        .catch(function (err) {});
      should.exist(promise);
    });
  });
  ...
  describe('#search', function () {
    it('should not return a promise with a callback', function () {
      var promise = org.search(
        { search: testSearch, oauth: oauth },
        testCallback
      );
      should.not.exist(promise);
    });
    ...
    it('should return a promise with no callback', function () {
      var promise = org
        .search({ search: testSearch, oauth: oauth })
        .catch(function (err) {});
      should.exist(promise);
    });
  });
